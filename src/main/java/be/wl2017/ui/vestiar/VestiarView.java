...
@UIScope
@SpringView(name = VestiarView.VIEW_NAME)
public class VestiarView extends VerticalLayout implements View {
    public static final String VIEW_NAME = "vestiar";
    ...
    private MTable<Vestiar> list = new MTable<>(Vestiar.class)
            .withProperties("name", "location")
            .withColumnHeaders("Name","Location")
    ...
    void init() {
        ...
        listEntities();
        list.addMValueChangeListener(new MValueChangeListener<Vestiar>() {
            @Override
            public void valueChange(MValueChangeEvent<Vestiar> e) {
                VestiarView.this.adjustActionButtonState();
            }
        });
    ...
    protected void edit(final Vestiar vestiar) {
        form.setEntity(vestiar);
        form.openInModalPopup();
    }

    @EventBusListenerMethod(scope = EventScope.UI)
    public void onVestiarModified(VestiarModifiedEvent event) {
        listEntities();
        form.closePopup();
    }
